object chap6 {
  ...
  positiveMax(1000).run(RNG.simple(System.currentTimeMillis))
                                                  //> res0: (Int, chap6.RNG) = (250,chap6$RNG$$anon$1@78812862)
  ...
  positiveInt.run(RNG.simple(System.currentTimeMillis))
                                                  //> res1: (Int, chap6.RNG) = (531138004,chap6$RNG$$anon$1@65f9b56b)
